...
![MoniArc 深色状态岛预览](docs/moniarc-hero.jpg)
...
MoniArc 仅通过 GitHub 分发：从 [GitHub Releases](https://github.com/ch3n923/MoniArc/releases) 下载最新的发布包。它不会在 Mac App Store 或独立官网提供下载。
