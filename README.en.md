...
![MoniArc status island preview](docs/moniarc-hero.jpg)
...
MoniArc is distributed exclusively through GitHub. Download the latest release from [GitHub Releases](https://github.com/ch3n923/MoniArc/releases). It is not distributed through the Mac App Store or a standalone download website.
